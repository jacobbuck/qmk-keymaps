...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |----------------------------------------------------------------|
     * |     |Br-|Br+|   |BlT|BlS|   |Prv|Ply|Nxt|Mut|V- |V+ |Reset| MC |
     * |----------------------------------------------------------------|
     * |      |   |   |   |Find|   |   |   |   |   |   |   |       | AW |
     * |----------------------------------------------------------------|
    ...
    [_FN] = LAYOUT_65_ansi(
        ...
        XXXXXXX, KC_BRID, KC_BRIU, XXXXXXX, BL_TOGG, BL_STEP, XXXXXXX, KC_MPRV, KC_MPLY, KC_MNXT, KC_MUTE, KC_VOLD, KC_VOLU, QK_BOOT, _______,
